...
local Window = Fluent:CreateWindow({
    Title = "Welly hub | Blox Fruits(Beta)",
    SubTitle = " By Taidz",
    TabWidth = 160,
...
local Tabs = {
    ...
    Lc = Window:AddTab({ Title = "Travel Tab", Icon = "wifi" }),   
    spl = Window:AddTab({ Title = "Player Status", Icon = "baby" }),   
    ...
    Ms = Window:AddTab({ Title = "Misc Tab", Icon = "list-plus" }),   
...
task.spawn(function()
    ...
    local Dropdown = Tabs.Settings:AddDropdown("Dropdown", {
        Title = "Attack",
        Values = {"0", "0.000000000000000000001", "0.15", "0.16", "0.175", "0.185", "1", "2", "3", "4"},
        Multi = false,
        Default = 5,
    })
    ...
    while wait(.1) do
        if _G.FastAttackDelay then
            pcall(function()
                ...
                elseif _G.FastAttackDelay == "0.000000000000000000001" then
                    _G.FastAttackDelay = 0.000000000000000000001
